...
area=$("#CodArea option:selected").val();
tipo=$("#tipo option:selected").val();
subtipo=$("#subtipo option:selected").val();
var ruta = "public\\" + area + "\\"+ tipo + "\\" + subtipo + "\\";
var nombre = "JoseCastillo.pdf";
/*-----------------Load Image---------------------*/
function btnLoadImagesOrPDFs_onclick() {
    ...
    var pathBase=window.location.origin;
...
function saveUploadImage(type) {
    /*funcion para validar si se guardará localmente o en el servidor*/
	if(type=='local'){
        btnSave_onclick();
...
function btnSave_onclick() {
    ...
    var i, strimgType_save,area,tipo,subtipo;
    ...
    if (strimgType_save == "tif" && _chkMultiPageTIFF_save && _chkMultiPageTIFF_save.checked) {
        ...
        /*metodo para seleccionar pdf*/
    else if (strimgType_save == "pdf" && document.getElementById("MultiPagePDF").checked && area == "TI" )
    {
        vAsyn = true;
        if ((DWObject.SelectedImagesCount == 1) || (DWObject.SelectedImagesCount == DWObject.HowManyImagesInBuffer)) 
        {
            bSave = DWObject.SaveAllAsPDF(ruta + strFilePath, OnSuccess, OnFailure);
        }
        else {
            bSave = DWObject.SaveSelectedImagesAsMultiPagePDF(ruta + strFilePath, OnSuccess, OnFailure);
        }
        
    }
    else if (strimgType_save == "pdf" && document.getElementById("MultiPagePDF").checked && area == "AL")
    {
        vAsyn = true;
        if ((DWObject.SelectedImagesCount == 1) || (DWObject.SelectedImagesCount == DWObject.HowManyImagesInBuffer)) {
            bSave = DWObject.SaveAllAsPDF(ruta + strFilePath, OnSuccess, OnFailure);
    ...
    else if (strimgType_save == "pdf" && document.getElementById("MultiPagePDF").checked && area == "CM")
    {
        vAsyn = true;
        if ((DWObject.SelectedImagesCount == 1) || (DWObject.SelectedImagesCount == DWObject.HowManyImagesInBuffer)) {
            bSave = DWObject.SaveAllAsPDF(ruta + strFilePath, OnSuccess, OnFailure);
    ...
    else if (strimgType_save == "pdf" && document.getElementById("MultiPagePDF").checked && area == "FT")
    {
        vAsyn = true;
        if ((DWObject.SelectedImagesCount == 1) || (DWObject.SelectedImagesCount == DWObject.HowManyImagesInBuffer)) {
            bSave = DWObject.SaveAllAsPDF(ruta + strFilePath, OnSuccess, OnFailure);
    ...
    else if (strimgType_save == "pdf" && document.getElementById("MultiPagePDF").checked && area == "GP")
    {
        vAsyn = true;
        if ((DWObject.SelectedImagesCount == 1) || (DWObject.SelectedImagesCount == DWObject.HowManyImagesInBuffer)) {
            bSave = DWObject.SaveAllAsPDF(ruta + strFilePath, OnSuccess, OnFailure);
    ...
    else if (strimgType_save == "pdf" && document.getElementById("MultiPagePDF").checked && area == "CT")
    {
        vAsyn = true;
        if ((DWObject.SelectedImagesCount == 1) || (DWObject.SelectedImagesCount == DWObject.HowManyImagesInBuffer)) {
            bSave = DWObject.SaveAllAsPDF(ruta + strFilePath, OnSuccess, OnFailure);
        ...
        switch (i) {
            case 0: bSave = DWObject.SaveAsBMP(ruta + strFilePath, DWObject.CurrentImageIndexInBuffer); break;
            case 1: bSave = DWObject.SaveAsJPEG(ruta + strFilePath, DWObject.CurrentImageIndexInBuffer); break;
            case 2: bSave = DWObject.SaveAsTIFF(ruta + strFilePath, DWObject.CurrentImageIndexInBuffer); break;
            case 3: bSave = DWObject.SaveAsPNG(ruta + strFilePath, DWObject.CurrentImageIndexInBuffer); break;
            case 4: bSave = DWObject.SaveAsPDF(ruta + strFilePath, DWObject.CurrentImageIndexInBuffer); break;
        }
    }
